...
ARQUIVO_FONTE = os.path.join(PASTA_RAW, "12 - TipoVeiculo_DadosAbertos.csv")
ARQUIVO_SAIDA = os.path.join(PASTA_SAIDA, "veiculos_consolidado_2025.parquet")
...
print("✅ Arquivo de veículos 2025 criado com sucesso.")