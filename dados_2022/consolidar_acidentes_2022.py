...
ARQUIVO_FONTE = os.path.join(PASTA_RAW, "9 - Acidentes_DadosAbertos_Setembro.csv")
ARQUIVO_SAIDA = os.path.join(PASTA_SAIDA, "acidentes_consolidado_2022.parquet")
...
print("✅ Novo arquivo de acidentes 2022 criado com sucesso.")