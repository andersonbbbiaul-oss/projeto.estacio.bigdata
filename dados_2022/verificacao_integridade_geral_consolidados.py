...
ARQ_ACIDENTES   = os.path.join(PASTA, "acidentes_consolidado_2022.parquet")
ARQ_LOCALIDADES = os.path.join(PASTA, "localidades_consolidado_2022.parquet")  # arquivo enxuto, sem num_acidente
ARQ_VEICULOS    = os.path.join(PASTA, "veiculos_consolidado_2022.parquet")
ARQ_VITIMAS     = os.path.join(PASTA, "vitimas_consolidado_2022.parquet")
...
anos_validos = set(range(2018, 2023))  # 2022 não tem 2023
anos_presentes = set(df_ac['ano_acidente'].unique())
check(anos_presentes == anos_validos,
      "Anos de 2018 a 2022 presentes",
