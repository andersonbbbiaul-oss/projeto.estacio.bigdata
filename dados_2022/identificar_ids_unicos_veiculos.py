...
for arq in os.listdir(PASTA_2022):
    ...
    if len(partes) == 2 and partes[1].startswith("TipoVeiculo"):
        try:
            ...
            # ignora se o prefixo não for número
            pass
...
ids_acumulados = set()
# Usamos ordem decrescente de mês
