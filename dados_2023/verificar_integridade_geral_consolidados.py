...
ARQ_LOCALIDADES = os.path.join(PASTA, "localidades_consolidado_2023.parquet")
...
# ------------------------------------------------------------
print("\n" + "=" * 70)
print("VERIFICAÇÃO COMPLETA – CONSOLIDADOS 2023 (29 itens)")
print("=" * 70)
