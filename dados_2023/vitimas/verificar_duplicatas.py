...
for arq in os.listdir(PASTA):
    ...
    if len(partes) == 2:
        ...
        if prefixo.strip().isdigit() and resto.startswith("Vitimas"):
            arquivos_vitimas.append(arq)

print(f"📂 {len(arquivos_vitimas)} arquivos de Vitimas encontrados em 2023.\n")

# Calcular hashes
hashes = defaultdict(list)
for arq in sorted(arquivos_vitimas):
