...
# Coletar arquivos de TipoVeiculo
arquivos_veiculos = []
for arq in os.listdir(PASTA):
    ...
    if len(partes) == 2:
        ...
        if prefixo.strip().isdigit() and resto.startswith("TipoVeiculo"):
            arquivos_veiculos.append(arq)

print(f"📂 {len(arquivos_veiculos)} arquivos de TipoVeiculo encontrados em 2023.\n")

# Calcular hashes
hashes = defaultdict(list)
for arq in sorted(arquivos_veiculos):
