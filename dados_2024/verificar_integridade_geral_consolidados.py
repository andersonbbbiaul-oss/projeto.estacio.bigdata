...
ARQ_LOCALIDADES = os.path.join(PASTA, "localidades_consolidado_filtrado_2024.parquet")  # arquivo enxuto, sem num_acidente
ARQ_VEICULOS    = os.path.join(PASTA, "veiculos_consolidado_2024.parquet")
ARQ_VITIMAS     = os.path.join(PASTA, "vitimas_consolidado_2024.parquet")
...
# ------------------------------------------------------------
print("\n" + "=" * 70)
print("VERIFICAÇÃO COMPLETA – CONSOLIDADOS 2024 (29 itens)")
print("=" * 70)
...
# Ajuste: 2024 contém até 2024
anos_validos = set(range(2018, 2025))
anos_presentes = set(df_ac['ano_acidente'].unique())
check(anos_presentes == anos_validos,
      "Anos de 2018 a 2024 presentes",
