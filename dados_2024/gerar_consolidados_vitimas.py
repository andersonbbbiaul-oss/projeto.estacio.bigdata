...
ARQUIVO_FONTE = os.path.join(PASTA_RAW, "12 - Vitimas_DadosAbertos.csv")
ARQUIVO_SAIDA = os.path.join(PASTA_SAIDA, "vitimas_consolidado_2024.parquet")
...
print("✅ Arquivo de vítimas 2024 criado com sucesso.")